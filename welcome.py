...
def intro1():
    ...
    print(f'{Fore.LIGHTRED_EX}  .////:`      ``-://///////-.`  `-///- {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX} `///////---::/::-.-:///:-`     .:///:` {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX} -/////:--..``` `.---.`      `.::-:/:`  {Style.RESET_ALL}{Fore.CYAN}Repo{Style.RESET_ALL}: https://github.com/kodaneflash/hawk')
    print(f'{Fore.LIGHTRED_EX} :///:.`..                `.:/:.`-/:`   {Style.RESET_ALL}{Fore.CYAN}Email{Style.RESET_ALL}: kodaneflash@gmail.com') 
